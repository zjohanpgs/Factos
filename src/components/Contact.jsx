export default function Contact() {
  return (
    <section id="contacto" className="bg-navy-800 py-24">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-start gap-12">
          <div>
            <h2 className="font-[Montserrat] font-bold text-2xl text-white uppercase mb-6">
              Contacto
            </h2>
            <div className="space-y-4 font-[Poppins] text-white/70">
              <p>Telefono: +51 932 332 576</p>
              <p>Email: gerencia@factos.pe</p>
            </div>
          </div>
