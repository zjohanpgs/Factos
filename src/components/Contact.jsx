      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 pt-12">
          ...
          <div>
            ...
            <ul className="space-y-3 font-[Poppins] text-white/40 text-sm">
              <li>+51 932 332 576</li>
              <li>gerencia@factos.pe</li>
              <li className="flex items-center gap-3 pt-2">
                ...
                <a href="https://wa.me/51932332576" target="_blank" rel="noopener noreferrer"
        ...
        <div className="mt-12 pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-[Poppins] text-white/20 text-sm">
            &copy; {new Date().getFullYear()} Factos. Todos los derechos reservados.
          </p>
